...
export default function FinancialToolsPage() {
  ...
  const [selectedTool, setSelectedTool] = useState<'interest' | null>(null);
        ...
        <div className="px-6 py-6 max-w-4xl mx-auto space-y-6">
          <div className="border-b border-border pb-5">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-foreground">Financial Tools</h1>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              type="button"
              onClick={() => setSelectedTool('interest')}
              className="text-left bg-card border border-border rounded-xl p-6 hover:border-primary/60 hover:bg-muted/20 transition"
            >
              <Calculator className="h-6 w-6 text-primary mb-3" />
              <h2 className="font-semibold text-foreground">Simple Interest Calculator</h2>
              <p className="text-sm text-muted-foreground mt-1">
                Calculate interest using flexible day-count conventions.
              </p>
            </button>

            <div className="bg-card/60 border border-border/60 rounded-xl p-6 opacity-70">
              <Sparkles className="h-6 w-6 text-info mb-3" />
              <h2 className="font-semibold text-foreground">Compound Interest Calculator</h2>
              <p className="text-sm text-muted-foreground mt-1">Coming soon.</p>
            </div>

            <div className="bg-card/60 border border-border/60 rounded-xl p-6 opacity-70">
              <Coins className="h-6 w-6 text-positive mb-3" />
              <h2 className="font-semibold text-foreground">EMI & Loan Amortization</h2>
              <p className="text-sm text-muted-foreground mt-1">Coming soon.</p>
            </div>
          </div>
        </div>
      ...
      <div className="px-6 py-6 xl:px-10 2xl:px-16 max-w-screen-2xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-border pb-5">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleReset}
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg border border-border text-sm font-medium hover:text-foreground hover:bg-muted/50 transition-all duration-150"
            >
              <RotateCcw size={14} />
              Clear Inputs
            </button>
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-sm font-medium transition-all duration-150 shadow-sm ${
                hasEmptyInputs
            ...
            <div className="bg-card border border-border rounded-xl p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full bg-card border border-border rounded-lg pl-8 pr-3 py-2 text-sm text-slate-200 focus:border-primary/50 focus:bg-card focus:outline-none focus:ring-1 focus:ring-primary/20 tabular-nums font-semibold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-card border border-border rounded-lg px-4 py-2 text-sm text-slate-200 focus:border-primary/50 focus:bg-card focus:outline-none focus:ring-1 focus:ring-primary/20"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-semibold tracking-wider text-muted-foreground uppercase flex items-center gap-1.5">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-card border border-border rounded-lg px-4 py-2 text-sm text-slate-200 focus:border-primary/50 focus:bg-card focus:outline-none focus:ring-1 focus:ring-primary/20 font-semibold"
                >
                  {CONVENTIONS.map((option) => (
                    <option key={option.value} value={option.value} className="bg-card text-slate-200 font-medium">
                      {option.label}
                    </option>
                  ))}
                </select>
