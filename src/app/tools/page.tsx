        ...
        <div className="px-6 py-6 max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="text-left bg-card border border-border rounded-xl p-5 hover:border-primary/60 hover:bg-muted/20 transition"
            >
            ...
            <div className="bg-card/60 border border-border/60 rounded-xl p-5 opacity-70">
